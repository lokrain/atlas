// Packages/com.lokrain.atlas/Runtime/Generation/Stages/Landmass/Fields/AtlasLandmassFields.ContinentSuitabilityCutoff.cs
//
...
namespace Lokrain.Atlas.Generation.Stages.Landmass.Fields
{
    ...
    {
        /// <summary>
        /// Stage-transient Q16.16 suitability cutoff scalar selected by EvaluateContinentSuitability.
        /// </summary>
        public readonly struct ContinentSuitabilityCutoff : IAtlasField<int>
        {
            public StableDataId StableId => AtlasLandmassFieldIds.ContinentSuitabilityCutoff;
            ...
            public AtlasShapeDomain ShapeDomain => AtlasShapeDomain.Scalar(new FixedString64Bytes(AtlasLandmassFieldNames.ContinentSuitabilityCutoff));
            ...
            public FixedString64Bytes DebugName => new FixedString64Bytes(AtlasLandmassFieldNames.ContinentSuitabilityCutoff);
        }
    }
}
